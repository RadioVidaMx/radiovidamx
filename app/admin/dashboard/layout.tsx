...
const navigation = [
    { name: "Dashboard", href: "/admin/dashboard", icon: LayoutDashboard, roles: ["admin", "writer", "galery", "operator"] },
    { name: "Artículos", href: "/admin/dashboard/articulos", icon: FileText, roles: ["admin", "writer"] },
    { name: "Eventos", href: "/admin/dashboard/eventos", icon: Calendar, roles: ["admin", "operator"] },
    { name: "Programación", href: "/admin/dashboard/programacion", icon: Tv, roles: ["admin", "operator"] },
...
export default function AdminLayout({
    ...
    useEffect(() => {
        const checkUser = async () => {
            ...
            const allowedRoles = ["admin", "writer", "galery", "operator"]
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className="lg:ml-64">
                ...
                {/* Page content */}
                <main className="p-4 lg:p-8 pb-48">
                    {children}
                </main>
            </div>
        </div>
